    ...
    return (
        <>
            ...
            <h1 className="my-10 font-medium text-5xl leading-tight tracking-normal">{profile.profileText}</h1>
                ...
                <div className="bg-[#52525280]  w-[20rem] xs:w-[20rem] rounded-2xl h-[15.5rem]">
                    <div className="bg-[#FFFFFF]  dark:bg-[#525252] w-[20rem] xs:w-[20rem]  h-60 flex flex-col rounded-2xl -ml-3">
                        ...
                        <div className="flex flex-row text-wrap text-left ml-12 ">
                            ...
                            <div className="flex flex-col text-left text-lg leading-5 tracking-tight">
